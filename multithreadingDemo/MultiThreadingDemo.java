...
public class MultiThreadingDemo extends Thread {
    ...
    public static void main(String[] args) {
        MultiThreadingDemo programOne = new MultiThreadingDemo("multithreading program one");
        MultiThreadingDemo programTwo = new MultiThreadingDemo("MULTITHREADING PROGRAM TWO");
        programOne.start();
        programTwo.start();
